...
export type { CreateTokenMetadata, TransactionResult, PriorityFee } from "./types";
...
export class PumpFunSDK {
  ...
  async createAndBuy (
    ...
    // In test mode, use faster confirmation and skip priority fees
    const effectiveCommitment = this.testMode ? "confirmed" as const : commitment;
    const effectiveFinality = this.testMode ? "confirmed" as const : finality;
    const effectivePriorityFees = this.testMode ? undefined : priorityFees;
